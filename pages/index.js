...
export default function Index() {
  ...
  return (
    <>
      <section className="bg-muroAtleticas flex justify-center items-center w-full h-screen" style={{backgroundImage: "url('/img/background-muro-atleticas.png')", backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center"}}>
